...
t.test(x = subset(cond.RT.sum, group=="OA" & condition=="baseline")$meanRT,
       ...
       paired = TRUE)
# calculate cohen's d
cohen.d(subset(cond.RT.sum, group=="OA" & condition=="incentive")$meanRT,
        subset(cond.RT.sum, group=="OA" & condition=="baseline")$meanRT,
...
t.test(x = subset(cond.RT.sum, group=="YA" & condition=="baseline")$meanRT,
       ...
       paired = TRUE)
cohen.d(subset(cond.RT.sum, group=="YA" & condition=="incentive")$meanRT,
        subset(cond.RT.sum, group=="YA" & condition=="baseline")$meanRT,
        na.rm = TRUE, pooled = TRUE, paired = TRUE, hedges.correction = FALSE)
```
...
\newpage
## Generalized Linear Mixed Effects Models: Reward Rate Effects by Monetary Reward and Age
```{r}
...
\newpage
## Generalized Linear Mixed Effects Models of RT by Monetary Reward and Age Group
```{r}
